# ClearCoin Translation Guide

The ClearCoin browser extension supports new translations added in the form of new locales files added in `app/_locales`.
...
- Add the language to the [locales index](https://github.com/clearcoin/extension/blob/master/app/_locales/index.json) `app/_locales/index.json` 


That's it! When ClearCoin is loaded on a computer with that language set as the system language, they will see your translation instead of the default one.
...
To verify that your translation works in the app, you will need to build a local copy of ClearCoin. You will need to change your browser language, your operating system language, and restart your browser.
